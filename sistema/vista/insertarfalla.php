...
<body>
      ...
      <form action="../Controlador/insertarfalla.php" class="inline" method="POST" accept-charset="utf-8">
    ...
    <p style="color:#0016b0">agregar al final de cada parrafo <IMG src="../images/br.png" width="80" height="76"  /></p>
    <div class="form-group">
				   <label for="pwd">Solucion:</label>
				<textarea name="repositorios"  rows="30" cols="100" class="form-control" id="pwd" ></textarea>
				</div>

					<input class="btn btn-success" type="submit" value="guardar falla">
