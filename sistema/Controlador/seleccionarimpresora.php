...
function seleccionar(){
		if (isset($_GET['codigo'])) {
			...
			foreach ($filas as $fila) {
				...
				<form action="../Controlador/modificarimpresora.php" method="post"> 
				<div class="form-group">
				<label for="usr">Codigo:</label>
				<input type="text"   name="codigo" value="'.$fila['codigo'].'"  class="form-control" id="usr">
				</div>
				<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="cable_usb" value="'.$fila['cable_usb'].'"  class="form-control" id="pwd">
			</div>
			<div class="form-group">
			<label for="pwd">Toner:</label>
			<input type="text" name="toner" value="'.$fila['toner'].'" class="form-control" id="pwd">
		</div>
				<div class="form-group">
			...
			<input class="btn btn-success" type="submit" value="Modificar impresora">
					<a href="impresoras.php" class="btn btn-danger">volver</a>
