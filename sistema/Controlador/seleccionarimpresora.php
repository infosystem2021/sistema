			...
			foreach ($filas as $fila) {
               ...
               <form action="../Controlador/modificarimpresora.php" method="post"> 
				...
				<tr>
					...
					<td><input type="text" name="toner" value="'.$fila['toner'].'"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>&nbsp;</td>
					<td><input class="btn btn-success" type="submit" value="Modificar impresora">
					<a href="verimpresoras.php" class="btn btn-success"</a>volver</td>
				</tr>
		</table>
