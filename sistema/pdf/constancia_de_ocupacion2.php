...
<html>
  ...
  <body  >
      ...
      <p style="text-align:center">
        <strong><span style="font-family:Arial; ">CONSTANCIA DE OCUPACION</span></strong>
      </p>
    
      <p style="text-indent:35.4pt; text-align:justify; line-height:200%; font-size:12pt">
        <span style="font-family:Arial">Nosotros los abajo firmantes, integrantes de la Junta Directiva del Consejo Comunal “La Nueva Victoria”; por medio del presente documento, hacemos costar que el / (la) ciudadano (a): '.$nombre.' '.$apellido.' , venezolano (a), mayor de edad y titular de la cedula de Identidad Nro: '.$nacionalidad.'-'.$cedula.'  ocupa un lote de terreno Municipal ubicado en la siguiente direccion:'. $direccion.' , <B>Parroquia:</B> '.$parroquia.' <b>Municipio:</b> '.$municipio.' </span><strong><span style="font-family:Arial; ">Acarigua – Edo -  Portuguesa.</span></strong> Y CUYO LOS LINDERES SON:
     
     </p>
           
        &nbsp;&nbsp;por el norte: ___________________
        por el sur: ______________________<br> 
        por el este: _____________________
        por el oeste: ____________________<br>
        medidas del terreno:_______________
   ...
   <p style="text-indent:35.4pt; text-align:justify; line-height:200%; font-size:12pt">
        <span style="font-family:Arial">Constancia que se expide de la parte  interesada  en Acarigua a los '.$dia.' días del mes de ' .$mes.' del  '.$anos.' .</span>
      </p>
     
      <p style="line-height:200%; font-size:10pt">
    ...
    <p style="text-align:left; line-height:150%; font-size:10pt">
    ...
    <br>
      ...
      <br>
        ...
        <Footer>
               <p style="font-size:10pt; text-align:center">Calle principal, Urb. La Nueva Victoria, Acarigua-Edo-Portuguesa <br>
