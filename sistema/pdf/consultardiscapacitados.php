<?php 
	...
	$usuario = 'SELECT * FROM jefes_familia where Discapacitado = "si" ORDER BY cedula ASC';	
...
if(isset($_POST['create_pdf'])){
  ...
  require_once('conexion/conexion.php');  
  $usuario1 = 'SELECT * FROM grupo_familiar where discapacidad_miembro ="si" ORDER BY cedula_miembro ASC'; 
	...
	<div class="container-fluid">
        <div class="row padding">
          <div class="well well-well">
        	<div class="col-md-12">
            	<?php $h1 = "Datos de los Discapacitados en pdf";  
            	 echo '<h1>'.$h1.'</h1>'
				?>
            </div>
         ...
         <?php } ?>
              ...
              <div class="col-md-12">
                <form method="post">
                  ...
                  <a href="../vista/cargardiscapacidad.php" class="btn btn-danger pull-left" > Volver</a>
