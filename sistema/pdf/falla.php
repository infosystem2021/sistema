...
$consultar= new pdf();
  $filas = $consultar->cargarFalla($codigo);
...
<html>
 ...
 '.$user['falla'].'
      ...
      <p style="text-align:center">
        <strong><span style="font-family:Arial; ">DATOS DE FALLAS SOLUCIONADAS</span></strong>
      </p>
	...
	<div class="container">
        ...
        <div>
            ...
            <header><img src="alcaldia.png" width="100%" height="80" alt="" ></header>
            	<?php $h1 = "Datos de Fallas solucionadas en pdf";
               echo '<h1 style="text-align:left">'.$h1.'</h1>
               <div>
               <form method="post">
               <input type="hidden" name="reporte_name" value="<?php echo $h1; ?>">
                 <a href="../vista/fallas.php" class="btn btn-danger" > Volver</a>
       ...
       <div class="form-group">
         ...
         <input type="text" name="departamento" value="<?php echo $user['falla']; ?>" disabled class="form-control" id="pwd">
      </div>
      <div class="form-group">
       <label for="pwd">Solucion:</label>
       <textarea name="repositorios" rows="30" cols="100" id="pwd" class="form-control"  ><?php echo $user['solucion']; ?></textarea>
     </div>
