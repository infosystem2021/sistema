<?php 
	...
	$usuario = 'SELECT * FROM grupo_familiar  ORDER BY cedula_miembro ASC';	
...
<body>
	<div class="container-fluid">
        <div class="row padding">
        	<div class="col-md-12">
            	<?php $h1 = "Datos de los Miembros de Familias en pdf";  
            	 echo '<h1>'.$h1.'</h1>'
				?>
            </div>
         ...
         <?php } ?>
              ...
              <div class="col-md-12">
                <form method="post">
                  ...
                  <a href="../vista/vergrupo.php" class="btn btn-danger pull-left" > Volver</a>
