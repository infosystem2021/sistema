...
<body style="background-color:#FFC2A8">
 ...
 <br>
  <div class="col-md-12">
                      <?php $h1 = "Constancia de Ocupacion";  
                              echo '<h1>'.$h1.'</h1>'
                        ?>
                </div>
  <div class="well well-well">
        <div class="row padding">
                 ...
                 <div class="col-md-12"  >   
                      ...
                      <form method="post" action="constancia_de_ocupacion2.php">                            
                      ...
                      <p>
                        ...
                        <input type="text" name="direccion" placeholder="introduzca su direccion" required>
                         &nbsp;&nbsp;<span class="label label-default">PARROQUIA</span>
                        <input type="text" name="parroquia" placeholder="introduzca su parroquia" required>
                         &nbsp;&nbsp;<span class="label label-default">MUNICIPIO</span>
                        <input type="text" name="municipio" placeholder="introduzca su municipio" required>
                        </p>
